...
scored all 20 hints on a 3-point Socratic rubric (0\,=\,gives the
answer; 1\,=\,partial; 2\,=\,fully Socratic question), with
inter-rater $\kappa\!=\!0.71$ (substantial agreement). When runtime
error was captured, mean rating was \textbf{2.6/3.0}; without a crash
(silent logical error) it dropped to 1.4/3.0, confirming runtime error
